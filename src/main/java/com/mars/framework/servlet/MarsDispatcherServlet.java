package com.mars.framework.servlet;

import com.mars.framework.annotation.*;
        ...
        private void putParamIndexMapping(Method method) {
            ...
            for(int i = 0; i < pa.length; i ++) {
                for(Annotation a : pa[i]) {
                    if(a instanceof MarsRequestParam) {
                        String paramName = ((MarsRequestParam) a).value();
                        if(!"".equals(paramName)) {
